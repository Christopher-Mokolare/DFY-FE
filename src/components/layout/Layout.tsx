...
const USER_WORKSPACE_ROUTES = ['/dashboard', '/tasks/post', '/tasks/browse', '/tasks/my-posted', '/tasks/action-required', '/tasks/my-active', '/tasks/my-completed', '/activity', '/notifications', '/messages', '/user/profile', '/user/bank-accounts']
